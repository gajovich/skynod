(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".selector__slider")) new swiper_core_Swiper(".selector__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".selector__button-prev",
                    nextEl: ".selector__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.5,
            ...
            if (document.querySelector(".panel__slider")) new swiper_core_Swiper(".panel__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".panel__button-prev",
                    nextEl: ".panel__button-next"
                },
                loop: true,
                breakpoints: {
                    320: {
